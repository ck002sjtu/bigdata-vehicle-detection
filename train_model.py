...
def train_model(model_path, imageFile, samples_per_epoch=160, save_path='new_model.h5',
	...
	para:
		imageFile: ex:/images/imagelist.txt should have the form. origin in top left.
			And the number of boxes in one image is not certain, it varies
			image_path1, x, y, w, h, class, x, y, w, h, class
			image_path2, x, y, w, h, class
			...
			ex:
	...
	return:
		the original model. whose output is (13, 13, 425)
	"""
